package com.putrisuai201103646.recyclerviewa;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nm = new NegaraModel();
        nm.setNama("Slovenia");
        nm.setDeskripsi("Belum ada deskripsi untuk negara ini. Silahkan ditambahkkan bagi yang memiliki informasi");
        ...
        nm = new NegaraModel();
        nm.setNama("Canada");
        nm.setDeskripsi("Negara ini terdapat di sebelah utaea negara Amerika Serikat");
